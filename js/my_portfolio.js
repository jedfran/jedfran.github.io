// Function that opens and close CONTACT form
function openForm() {
...
// Function displays first image in the slideshow when page is loaded
var slideIndex = 1;
showSlides(slideIndex);

// Function changes the slide when 'NEXT' or 'PREVIOUS' buttons are clicked
function plusSlides(n) {
    showSlides(slideIndex += n);
}

// Function changes the slide when the dots at the bottom of the images are clicked
...
function showSlides(n) {
    ...
    // next and prev buttons happenings
...
// Eventlistener when user clicks on the page
